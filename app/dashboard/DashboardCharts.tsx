  ...
  return (
    <div style={{ display: 'flex', gap: 16, marginTop: 20, flexWrap: 'wrap' }}>
      <div style={{ ...s.chartCard, flex: 2, minWidth: 320 }}>
        <h3 style={{ color: '#f8fafc', margin: '0 0 16px' }}>الإيرادات: اشتراكات مقابل مخزون</h3>
        <ResponsiveContainer width="100%" height={240}>
          <LineChart data={revenueData}>
            ...
            <Line type="monotone" dataKey="subscriptionAmount" name="الاشتراكات" stroke="#22c55e" strokeWidth={3} dot={{ r: 4, fill: '#22c55e' }} />
            <Line type="monotone" dataKey="inventoryAmount" name="المخزون" stroke="#3b82f6" strokeWidth={3} dot={{ r: 4, fill: '#3b82f6' }} />
          </LineChart>
        </ResponsiveContainer>
      </div>
